  ...
  */
  ...
  parse._handleContentLine = function (line, state) {
    ...
    if (paramPos !== -1) {
      ...
      var parsedParamLength;
      if (typeof parsedParams[1] === 'string') {
        parsedParamLength = parsedParams[1].length;
      } else {
        parsedParamLength = parsedParams[1].reduce(function (accumulator, currentValue) {
  ...
  var RecurIterator = /*#__PURE__*/function () {
    ...
    return _createClass(RecurIterator, [{
      ...
      value: function init() {
        ...
        // BYWEEKNO may appear.
        if ((this.rule.freq == "MONTHLY" || this.rule.freq == "LUNAR_MONTHLY") && ("BYYEARDAY" in parts || "BYWEEKNO" in parts)) {
          throw new Error("For MONTHLY/LUNAR_MONTHLY recurrences neither BYYEARDAY nor BYWEEKNO may appear");
        }
        ...
        if ((this.rule.freq != "YEARLY" || this.rule.freq != "LUNAR_YEARLY") && "BYYEARDAY" in parts) {
          throw new Error("BYYEARDAY may only appear in YEARLY/LUNAR_YEARLY rules");
        }
  ...
  _defineProperty(RecurIterator, "_expandMap", {
    ...
    "LUNAR_MONTHLY": [2, 2, 2, 2, 2, 3, 3, 1],
    "YEARLY": [2, 2, 2, 2, 2, 2, 2, 2],
    "LUNAR_YEARLY": [2, 2, 2, 2, 2, 2, 2, 2]
  });
  ...
  var ALLOWED_FREQ = ['SECONDLY', 'MINUTELY', 'HOURLY', 'DAILY', 'WEEKLY', 'MONTHLY', 'LUNAR_MONTHLY', 'YEARLY', 'LUNAR_YEARLY'];
